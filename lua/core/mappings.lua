...
function M.setup_which_key()
  ...
  wk.register({
    ...
    s = {
      name = "+Search",
      D = { ":lua require('mood-scripts.custom_telescope').live_grep_in_folder({ respect_gitignore = true })<CR>",
      ...
      p = { '<cmd>lua require("telescope.builtin").live_grep({ additional_args = { "-j1" }})<CR>',
